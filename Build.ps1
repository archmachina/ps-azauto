...
Invoke-BuildStage -Name "Build" -Filters $Stages -Script {
    ...
    Write-Information "Templating Noveris.AzAuto.psd1"
    Format-TemplateFile -Template source/Noveris.AzAuto.psd1.tpl -Target source/Noveris.AzAuto/Noveris.AzAuto.psd1 -Content @{
    ...
    Install-PSModuleFromManifest -ManifestPath source/Noveris.AzAuto/Noveris.AzAuto.psd1

    # Test the module manifest
    Write-Information "Testing module manifest"
    Test-ModuleManifest source/Noveris.AzAuto/Noveris.AzAuto.psd1

    # Import modules as test
    Write-Information "Importing module"
    Import-Module ./source/Noveris.AzAuto/Noveris.AzAuto.psm1
}

Invoke-BuildStage -Name "Release" -Filters $Stages -Script {
    $owner = "noveris-inf"
    $repo = "noveris-ps-azauto"
...
Invoke-BuildStage -Name "Publish" -Filters $Stages -Script {
    ...
    Publish-Module -Path ./source/Noveris.AzAuto -NuGetApiKey $Env:NUGET_API_KEY
}
